...
public class Rocket extends GameObject {
    ...
    public Rocket(double x, double y) {
        ...
        downFire = new RocketFire(new ArrayList<int[][]>(){{
            add(ShapeMatrix.FIRE_DOWN_1);
            add(ShapeMatrix.FIRE_DOWN_2);
            add(ShapeMatrix.FIRE_DOWN_3);
        }});
        leftFire = new RocketFire(new ArrayList<int[][]>(){{
            add(ShapeMatrix.FIRE_SIDE_1);
            add(ShapeMatrix.FIRE_SIDE_2);
        }});
        rightFire = new RocketFire(new ArrayList<int[][]>(){{
            add(ShapeMatrix.FIRE_SIDE_1);
            add(ShapeMatrix.FIRE_SIDE_2);
        }});
    }
